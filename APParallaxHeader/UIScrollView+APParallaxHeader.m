...
- (void)addParallaxWithImage:(NSString *)image andHeight:(CGFloat)height {
    ...
    if(self.parallaxView) {
        ...
        [self.parallaxView.imageView sd_setImageWithURL:[NSURL URLWithString:image]
                                       placeholderImage:[UIImage imageNamed:@"ProductPlaceholder"]];
    }
        ...
        
    {
        ...
        [view.imageView sd_setImageWithURL:[NSURL URLWithString:image]
                          placeholderImage:[UIImage imageNamed:@"ProductPlaceholder"]];
...
- (id)initWithFrame:(CGRect)frame andShadow:(BOOL)shadow {
    ...
    if(self = [super initWithFrame:frame]) {
        ...
        [self.effectView setAutoresizingMask:UIViewAutoresizingFlexibleHeight];
        
        [self.effectView setContentMode:UIViewContentModeScaleAspectFill];
        
        self.effectView.frame = CGRectMake(0, 0, CGRectGetWidth(frame), CGRectGetHeight(frame));
